          ...
          <Reveal>
            <div>
              ...
              <p className="mt-4 text-muted">
                Accompagnement et mise en relation pour la transformation d'un
                café-tabac emblématique de Mulhouse. De la façade existante à la
                simulation 3D de l'intérieur rénové, j'ai coordonné les bons
                intervenants pour donner vie au projet.
              </p>
              <ul className="mt-6 space-y-3">
                {[
                  "Étude de l'existant et du potentiel du lieu",
                  "Mise en relation avec les corps de métier adaptés",
                  "Coordination des échanges jusqu'à la réalisation",
                ].map((p) => (
