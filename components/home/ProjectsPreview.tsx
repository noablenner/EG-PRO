    ...
    <section className="container-x py-20 md:py-28">
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <SectionHeading
          ...
          title={<>Des projets concrets, <span className="text-gradient">avant / après</span></>}
          intro="Glissez le curseur pour voir la transformation. Quelques projets que j'ai accompagnés sur le terrain."
        />
        <Reveal>
